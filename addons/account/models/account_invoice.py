...
class AccountPaymentTermLine(models.Model):
    ...
    day_of_the_month = fields.Integer(
        ...
        help="Day of the month on which the invoice must come to its term. If zero or "
             "negative, this value will be ignored, and no specific day will be set. "
             "If greater than the last day of a month, this number will instead select "
